            ...
            <ul id="typechose" style="display: inline-flex;">
                ...
                <c:forEach items="${requestScope.type}" var="c">
                        ...
                        <a style="padding-right: 7rem;" href="home?type_id=${c.type_id}">
                            <img src="${c.imagine}" width="80px" height="auto" alt=""/>
        ...
        <style>
            ...
            <c:forEach items="${requestScope.listupdate}" var="c">
                <div id="boxing">
                    ...
                    <c:set var = "role" scope = "session" value = "${sessionScope.acc.getRole()}"/>
                    
                    <c:if test="${sessionScope.acc==null}">
                    <div style="color:red">
                        you haven't login yet
                        <a style="color: yellow;background-color: black" href="signup.jsp">do you want to login<a/>
                        </div>
                    </c:if>
                    <style>
                        .dontknow{
                    ...
                    <c:if test="${sessionScope.acc!=null}">
                        <div style="color:red">Dowload succesfully </div> 
